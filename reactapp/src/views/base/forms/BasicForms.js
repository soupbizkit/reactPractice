...
const BasicForms = () => {
  ...
  const fetchUser = async () => {
    const res = await axios.put('/guardar', { id: documento, nombre: nombre });
          ...
          <CCard>
            ...
            <CCardBody>
              <CRow>
                <CCol xs="12">
                  <CFormGroup>
                    <CLabel htmlFor="name">Documento</CLabel>
                    <CInput onChange={onChangedc} id="dcunivalle" placeholder="Registra documento " required />
                  </CFormGroup>
                </CCol>
              </CRow>
              <CRow>
                <CCol xs="12">
                  <CFormGroup>
                    ...
                    <CInput onChange={onChangenm} id="rgnombreunivalle" placeholder="Registra nombre " required />
                  </CFormGroup>
                </CCol>
              </CRow>
            </CCardBody>
            <CCardFooter>
              <CButton type="button" onClick={() => inserta()} size="sm" color="primary"><CIcon name="cil-scrubber" /> Insertar</CButton>
            </CCardFooter>
          </CCard>
        </CCol>
      </CRow>
